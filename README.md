...
Please read [`contributing guidelines`](https://github.com/ItzAshOffcl/awesome-webdev-resources/blob/main/contributing.md) ⭐ 222 | 🐛 14 | 📅 2024-11-22 before submitting new resources.
...
| [dynamics.js](https://github.com/michaelvillar/dynamics.js/) ⭐ 7,545 \| 🐛 9 \| 🌐 CoffeeScript \| 📅 2019-02-26 | Create physics-based animations with a JavaScript library.                                                                 |
...
| [Colord](https://github.com/omgovich/colord) ⭐ 1,879 \| 🐛 36 \| 🌐 TypeScript \| 📅 2026-05-23                | A tiny JavaScript library for high-performance color manipulation and conversion. |
...
| [Vanilla LazyLoad](https://github.com/verlok/vanilla-lazyload) ⭐ 7,857 \| 🐛 13 \| 🌐 JavaScript \| 📅 2026-06-22          | A lightweight, dependency-free lazy loading library for images and other content.  |
| [PhotoSwipe](https://github.com/dimsemenov/photoswipe) ⭐ 25,237 \| 🐛 170 \| 🌐 JavaScript \| 📅 2025-12-04                | A JavaScript image gallery for mobile and desktop with touch gestures.             |
| [LazyLoad by Tuupola](https://github.com/tuupola/lazyload) ⭐ 8,709 \| 🐛 109 \| 🌐 JavaScript \| 📅 2023-12-05             | A fast and lightweight lazy loading library for images and iframes.                |
...
| Library                                                                                                                    | Description                                                               |
| -------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| [ScrollReveal](https://github.com/jlmakes/scrollreveal) ⭐ 22,471 \| 🐛 41 \| 🌐 JavaScript \| 📅 2024-04-05                | A library to animate elements as they scroll into view.                   |
| [AOS (Animate On Scroll)](https://github.com/michalsnik/aos) ⭐ 28,061 \| 🐛 374 \| 🌐 JavaScript \| 📅 2024-03-26          | Animate elements on your website as you scroll.                           |
...
| [Rellax](https://github.com/dixonandmoe/rellax) ⭐ 7,135 \| 🐛 76 \| 🌐 HTML \| 📅 2024-08-24                               | A buttery smooth parallax library for any website.                        |
...
| [Locomotive Scroll](https://github.com/locomotivemtl/locomotive-scroll) ⭐ 8,842 \| 🐛 25 \| 🌐 JavaScript \| 📅 2026-06-30 | A smooth scrolling library built on the Intersection Observer API.        |
...
| [FullPage.js](https://github.com/alvarotrigo/fullPage.js) ⭐ 35,411 \| 🐛 127 \| 🌐 JavaScript \| 📅 2026-03-17             | Create full-screen scrolling websites with sections that scroll.          |
...
| Library                                                                                                        | Description                                                                                           |
| -------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| [Typed.js](https://github.com/mattboldt/typed.js) ⭐ 16,283 \| 🐛 22 \| 🌐 JavaScript \| 📅 2026-01-25          | A JavaScript library for creating customizable typing animations with various effects.                |
...
| [HLS.js](https://github.com/video-dev/hls.js) ⭐ 16,877 \| 🐛 88 \| 🌐 TypeScript \| 📅 2026-08-17                        | A JavaScript library that plays HLS video directly in the browser without needing Flash or plugins.                                          |
...
| [CSS Loaders GitHub](https://github.com/lukehaas/css-loaders) ⭐ 7,053 \| 🐛 21 \| 🌐 CSS \| 📅 2025-02-21 | GitHub repository with CSS loaders.             |
