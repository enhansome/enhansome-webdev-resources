...
Please read [`contributing guidelines`](https://github.com/ItzAshOffcl/awesome-webdev-resources/blob/main/contributing.md) ⭐ 221 | 🐛 13 | 📅 2024-11-22 before submitting new resources.
...
| [Instagram.css](https://github.com/picturepan2/instagram.css) ⭐ 4,012 \| 🐛 20 \| 🌐 CSS \| 📅 2023-01-15 | Collection of Instagram-like CSS filter effects.                    |
...
| [dynamics.js](https://github.com/michaelvillar/dynamics.js/) ⭐ 7,546 \| 🐛 9 \| 🌐 CoffeeScript \| 📅 2019-02-26 | Create physics-based animations with a JavaScript library.                                                                 |
...
| [ThreeAudio.js](https://github.com/unconed/ThreeAudio.js) ⭐ 541 \| 🐛 3 \| 🌐 JavaScript \| 📅 2015-10-17         | An extension of the Three.js library for integrating 3D audio in web applications.             |
...
| [Satellizer](https://github.com/sahat/satellizer) ⭐ 7,795 \| 🐛 289 \| 🌐 TypeScript \| 📅 2023-12-17 | An AngularJS authentication library for handling social login integrations and user authentication.         |
...
| [TinyColor](https://github.com/bgrins/TinyColor) ⭐ 5,247 \| 🐛 104 \| 🌐 JavaScript \| 📅 2024-06-26           | A small, fast JavaScript library for color manipulation and conversion.           |
...
| [Colord](https://github.com/omgovich/colord) ⭐ 1,878 \| 🐛 35 \| 🌐 TypeScript \| 📅 2026-05-23                | A tiny JavaScript library for high-performance color manipulation and conversion. |
| [D3-Color](https://github.com/d3/d3-color) ⭐ 426 \| 🐛 17 \| 🌐 JavaScript \| 📅 2024-02-03                    | Color spaces and color manipulation for D3.js.                                    |
...
| [ng2-file-upload](https://github.com/valor-software/ng2-file-upload) ⭐ 1,900 \| 🐛 425 \| 🌐 TypeScript \| 📅 2026-03-05 | Angular file upload library with support for multiple files and progress tracking.  |
...
| [Vanilla LazyLoad](https://github.com/verlok/vanilla-lazyload) ⭐ 7,855 \| 🐛 13 \| 🌐 JavaScript \| 📅 2026-06-22          | A lightweight, dependency-free lazy loading library for images and other content.  |
| [PhotoSwipe](https://github.com/dimsemenov/photoswipe) ⭐ 25,240 \| 🐛 169 \| 🌐 JavaScript \| 📅 2025-12-04                | A JavaScript image gallery for mobile and desktop with touch gestures.             |
| [LazyLoad by Tuupola](https://github.com/tuupola/lazyload) ⭐ 8,713 \| 🐛 109 \| 🌐 JavaScript \| 📅 2023-12-05             | A fast and lightweight lazy loading library for images and iframes.                |
...
| Library                                                                                                                    | Description                                                               |
| -------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| [ScrollReveal](https://github.com/jlmakes/scrollreveal) ⭐ 22,473 \| 🐛 41 \| 🌐 JavaScript \| 📅 2024-04-05                | A library to animate elements as they scroll into view.                   |
| [AOS (Animate On Scroll)](https://github.com/michalsnik/aos) ⭐ 28,065 \| 🐛 374 \| 🌐 JavaScript \| 📅 2024-03-26          | Animate elements on your website as you scroll.                           |
| [Parallax.js](https://github.com/pixelcog/parallax.js) ⭐ 3,535 \| 🐛 47 \| 🌐 JavaScript \| 📅 2022-05-11                  | A simple, lightweight parallax scrolling library.                         |
| [Rellax](https://github.com/dixonandmoe/rellax) ⭐ 7,136 \| 🐛 76 \| 🌐 HTML \| 📅 2024-08-24                               | A buttery smooth parallax library for any website.                        |
| [ScrollMagic](https://github.com/janpaepke/ScrollMagic) ⭐ 14,953 \| 🐛 4 \| 🌐 TypeScript \| 📅 2026-08-04                 | A JavaScript library for magical scroll interactions.                     |
| [Locomotive Scroll](https://github.com/locomotivemtl/locomotive-scroll) ⭐ 8,838 \| 🐛 25 \| 🌐 JavaScript \| 📅 2026-06-30 | A smooth scrolling library built on the Intersection Observer API.        |
...
| [FullPage.js](https://github.com/alvarotrigo/fullPage.js) ⭐ 35,414 \| 🐛 127 \| 🌐 JavaScript \| 📅 2026-03-17             | Create full-screen scrolling websites with sections that scroll.          |
| [Parallax Scroll](https://github.com/jscottsmith/react-scroll-parallax) ⭐ 2,985 \| 🐛 6 \| 🌐 TypeScript \| 📅 2026-08-12  | React components for scrolling/parallax effects.                          |
...
| Library                                                                                                        | Description                                                                                           |
| -------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| [Typed.js](https://github.com/mattboldt/typed.js) ⭐ 16,286 \| 🐛 22 \| 🌐 JavaScript \| 📅 2026-01-25          | A JavaScript library for creating customizable typing animations with various effects.                |
...
| [React Player](https://github.com/cookpete/react-player) ⭐ 10,280 \| 🐛 59 \| 🌐 TypeScript \| 📅 2025-11-13             | A React component for playing a variety of URLs, including YouTube, Facebook, and Vimeo videos.                                              |
...
| [React Plyr](https://github.com/sampotts/plyr) ⭐ 29,945 \| 🐛 936 \| 🌐 JavaScript \| 📅 2026-01-03                      | A React wrapper for the Plyr HTML5 media player.                                                                                             |
| [ng-video](https://www.npmjs.com/package/ng-video)                                                                       | A lightweight Angular library for embedding and controlling HTML5 videos.                                                                    |
| [Vue-Video-Player](https://github.com/surmon-china/vue-video-player) ⭐ 5,443 \| 🐛 200 \| 🌐 TypeScript \| 📅 2022-08-23 | A Vue.js video player based on Video.js with additional features like live streaming support.                                                |
| [HLS.js](https://github.com/video-dev/hls.js) ⭐ 16,873 \| 🐛 82 \| 🌐 TypeScript \| 📅 2026-08-12                        | A JavaScript library that plays HLS video directly in the browser without needing Flash or plugins.                                          |
...
| [CSS Loaders GitHub](https://github.com/lukehaas/css-loaders) ⭐ 7,056 \| 🐛 21 \| 🌐 CSS \| 📅 2025-02-21 | GitHub repository with CSS loaders.             |
