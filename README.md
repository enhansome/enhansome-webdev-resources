...
| [Color.js](https://github.com/Qix-/color) ⭐ 4,933 \| 🐛 20 \| 🌐 JavaScript \| 📅 2025-11-14                   | A color conversion and manipulation library for JavaScript.                       |
...
| [PhotoSwipe](https://github.com/dimsemenov/photoswipe) ⭐ 25,258 \| 🐛 170 \| 🌐 JavaScript \| 📅 2025-12-04                | A JavaScript image gallery for mobile and desktop with touch gestures.             |
...
| [Rellax](https://github.com/dixonandmoe/rellax) ⭐ 7,131 \| 🐛 77 \| 🌐 HTML \| 📅 2024-08-24                               | A buttery smooth parallax library for any website.                        |
| [ScrollMagic](https://github.com/janpaepke/ScrollMagic) ⭐ 14,959 \| 🐛 8 \| 🌐 TypeScript \| 📅 2026-09-11                 | A JavaScript library for magical scroll interactions.                     |
| [Locomotive Scroll](https://github.com/locomotivemtl/locomotive-scroll) ⭐ 8,862 \| 🐛 25 \| 🌐 JavaScript \| 📅 2026-06-30 | A smooth scrolling library built on the Intersection Observer API.        |
...
| [FullPage.js](https://github.com/alvarotrigo/fullPage.js) ⭐ 35,386 \| 🐛 130 \| 🌐 JavaScript \| 📅 2026-03-17             | Create full-screen scrolling websites with sections that scroll.          |
...
| [React Plyr](https://github.com/sampotts/plyr) ⭐ 29,999 \| 🐛 935 \| 🌐 JavaScript \| 📅 2026-09-19                      | A React wrapper for the Plyr HTML5 media player.                                                                                             |
...
| [HLS.js](https://github.com/video-dev/hls.js) ⭐ 16,947 \| 🐛 95 \| 🌐 TypeScript \| 📅 2026-09-17                        | A JavaScript library that plays HLS video directly in the browser without needing Flash or plugins.                                          |
